...
function Contact() {
  return (
    <div
      name="Contact"
      className="w-full h-screen bg-gradient-to-b from-gray-800 to-black px-4 text-white "
    >
      <div className="flex flex-col px-14 justify-centermax-w-screen-lg mx-auto h-full">
        <div className="pb-8">
        ...
        <div className="flex justify-center items-center">
          <form
            action="https://getform.io/f/aolgdpdb"
            method="POST"
